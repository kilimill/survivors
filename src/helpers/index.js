...
function videoGo(
	...
	qsAll(classContent).forEach((item, i) => {
		if (i == index) {
	...
	qsAll(classVideo).forEach((el, i) => {
		if (i == index) {
			...
			if (((typeof window.orientation !== "undefined") || (navigator.userAgent.indexOf('IEMobile') !== -1)) && window.innerWidth < 660) {
				el.play();
			}
			el.controls = true;
		}
